...
var HTMLonlineClassesStart = '<div class="onlineCourse-entry"></div>'
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    //   //if (projects.projects[project].location.length > 0)
    //   //{
    //     for (var loc in projects.projects[project].location)
    //     {
    //         console.log(projects.projects[project].location[loc]);
    //         locations.push(projects.projects[project].location[loc]);
    //     }
    //   //}
